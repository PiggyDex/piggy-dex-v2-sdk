...
import { CurrencyAmount, Percent, Ether, Token, WETH9 } from '@piggy-dex/sdk-core'
...
describe('Router', () => {
  ...
  const pair_weth_0 = new Pair(
    CurrencyAmount.fromRawAmount(WETH9[71], '1000'),
    ...
    describe('exact in', () => {
      it.only('ether to token1', () => {
        ...
        expect(result.args.slice(0, -1)).toEqual([
          '0x51',
          [WETH9[71].address, token0.address, token1.address],
      ...
      it('token1 to ether', () => {
        ...
        expect(result.args.slice(0, -1)).toEqual([
          '0x64',
          '0x51',
          [token1.address, token0.address, WETH9[71].address],
          '0x0000000000000000000000000000000000000004'
        ])
