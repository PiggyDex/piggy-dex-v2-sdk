...
// import { ChainId, CurrencyAmount, Price, Token, V2_FACTORY_ADDRESSES, WETH9 } from '@piggy-dex/sdk-core'
// import { InsufficientInputAmountError } from '../errors'
import { Token, V2_FACTORY_ADDRESSES } from '@piggy-dex/sdk-core'
import { computePairAddress } from './pair'

describe('computePairAddress', () => {
  it('should correctly compute the pool address', () => {
    const tokenA = new Token(71, '0x349298b0e20df67defd6efb8f3170cf4a32722ef', 18, 'USDC', 'USD Coin')
    const tokenB = new Token(71, '0x7d682e65efc5c13bf4e394b8f376c48e6bae0355', 18, 'USDT', 'Tether USD')
    const result = computePairAddress({
      factoryAddress: V2_FACTORY_ADDRESSES[71],
      tokenA,
      tokenB
    })

    expect(result).toEqual('0xA2CEF2e9Dc6de674a0C8B70C7471Cb0dfB0B575C')
  })
  it('should give same result regardless of token order', () => {
    const USDC = new Token(71, '0x349298b0e20df67defd6efb8f3170cf4a32722ef', 18, 'USDC', 'USD Coin')
    const USDT = new Token(71, '0x7d682e65efc5c13bf4e394b8f376c48e6bae0355', 18, 'USDT', 'Tether USD')
    let tokenA = USDC
    let tokenB = USDT
